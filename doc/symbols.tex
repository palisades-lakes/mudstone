...
\def\Uspace{\mathcal{U}}  % vector space
\def\Vspace{\mathcal{V}}  % vector space
\def\Wspace{\mathcal{W}}  % vector space

\def\Aspace{\mathcal{A}}  % affine space
\def\Tspace{\mathcal{T}}  % translation space (of an affine space)

\def\Lspace{\mathcal{L}} % space of of linear maps
...
\def\Identity{\mathcal{I}}   % the identity transformation
...
\def\linear_span{\mathrm{span}}    % linear span
\def\affine_span{\mathrm{aff}}    % affine span
\def\convex_span{\mathrm{hull}}    % convex span, convex hull

...
\input{rawtex/monomial-yy}

%-----------------------------------------------------------------
\levelstay{Input: $(x_0,y_0,d_0)$}

\input{rawtex/monomial-yd}
...
%-----------------------------------------------------------------
\levelstay{yydd}\label{sec:lagrange-yydd}
...
%-----------------------------------------------------------------
\levelstay{Hermite interpolation}
...
%-----------------------------------------------------------------
\setcounter{currentlevel}{\value{baseSectionLevel}}
\levelstay{Divided differences}{2}

...
%-----------------------------------------------------------------
\levelstay{General yydd}\label{sec:lagrange-yydd}
...
%-----------------------------------------------------------------
\levelstay{Hermite interpolation: yd2}
...
problem\cite{wiki:CubicHermiteSpline}.
...
%-----------------------------------------------------------------
\levelstay{Cubic Hermite: $(x_0,y_0,d_0),(x_1,y_1,d_1)$}

...
public interface ModelFactory {
  ...
  public default Function model (final Function f,
                                 final double[] x) {
    throw Exceptions.unsupportedOperation(this,"model",f,x); }
  ...
  public default Function model (final double[] z) {
    throw Exceptions.unsupportedOperation(this,"model",z); }
   ...
   */
  public double[] matchValueAt (final double[] x);

  /** A model function generated by <code>this.model(f,x)</code>
   * should match <code>f.slope</code> at the elements
   * of the returned array, which might be empty.
   */
  public double[] matchSlopeAt (final double[] x);

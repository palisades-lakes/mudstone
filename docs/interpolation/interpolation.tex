...
besdies giving a simpler system of equations to solve initially,
...
\begin{equation}
f(x) = \sum _{{j=0}}^{{k}}a_{{j}} {\nu}_{{j}}(x)
\end{equation}
where the basis functions are similar to the Lagrange:
\begin{equation}
{\nu}_{j}(x) \defeq \prod_{{i=0}}^{{j-1}}(x-x_{i})
\end{equation}
...
\subsection{$(x_0,y_0),(x_1,y_1,d_1)$}
...
\\
\partial{f}(x) & = a_1 + a_2 \left( (x - x_0) + (x - x_1) \right)
\nonumber
\end{align}

\begin{align}
y_0 = f(x_0) = a_0 & \Rightarrow a_0 = y_0 
\\
y_1 = f(x_1) = a_0 + a_1 (x_1 - x_0) & \Rightarrow 
a_1 = \frac{y_1-y_0}{x_1 - x_0} 
\nonumber \\
d_1 = \partial{f}(x_1) = a_1 + a_2 (x_1 - x_0) & \Rightarrow 
a_2 = \frac{d_1 (x_1 - x_0) - (y_1-y_0)}{(x_1 - x_0)^2} 
\nonumber
\end{align}
